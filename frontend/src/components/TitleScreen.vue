<template>
    <div class="titlescreen">
        <img class="logo" src="/image/event/tower.png">

        <h1 class="title">{{ getContent('main', 'title_text') }} !</h1>

        <form @submit.prevent="startGame">
            <input class="input" type="text" v-model="characterName"
                :placeholder="getContent('main', 'character_placeholder')">
            <button class="play" type="submit" @click="startGame">
                {{ getContent('main', 'play') }}
            </button>
        </form>
...
import { setInterface, getContent } from '../../utils/appState.js'
import { getCoreData, setCoreData, setEvent } from '../../utils/appHelper.js'
